...
cta:
  ...
  body: "Open TradingView and explore charts, alerts, and screeners. New users: personal $15 promo code emailed after the first purchase (valid 12 months, not applicable on sale prices). This link is affiliated."
...
internalLinks:
  ...
  - href: "/tools/tradingview-pricing/"
    anchor: "TradingView pricing: free vs paid (how to choose)"
...
The free plan is enough to learn the platform and build a process. For a simple decision framework, see our [TradingView pricing guide](/tools/tradingview-pricing/).

Consider upgrading only when a specific limit repeatedly blocks you, for example:
