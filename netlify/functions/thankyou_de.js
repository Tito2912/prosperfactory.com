...
const CHECKOUT_FALLBACK = "/de/zahlung";
...
<html lang="${LANG}">
  <head>
    ...
    <title>Geschützter Zugriff — Prosper Factory</title>
  ...
  <body>
    <main>
      <h1>Geschützter Zugriff</h1>
      <p>Diese Seite ist nach der Zahlung verfügbar. Bitte öffne sie über den Stripe-Bestätigungslink (er enthält das Session-Token).</p>
      <div class="actions">
        <a class="btn" href="${CHECKOUT_FALLBACK}" rel="nofollow">Zur Zahlung</a>
        <a class="ghost" href="${mailto}" rel="nofollow">Support kontaktieren</a>
      </div>
      <p class="fine"><a href="${HOME_FALLBACK}" rel="nofollow" style="color:var(--accent);text-decoration:none">Zur Startseite</a></p>
    </main>
  </body>
</html>`;
